...
from arch_v3 import ConvEncoder

# =========================================================================== #
# =========================================================================== #

class PredictionNetwork_V3(LightningModule):
    ...
    def __init__(self,     
        ...
        self.convnet = ConvEncoder(img_channels=5)
        self.lin = nn.Sequential(       
            nn.LazyLinear(out_features=num_classes, dtype=torch.float32),
            nn.Sigmoid()
        )
